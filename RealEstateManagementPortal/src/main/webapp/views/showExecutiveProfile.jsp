	...
	<header class="header">
		<nav class="navbar">
			<div class="container-fluid">
				<a href="/executivePortal" class="navbar-brand"><img
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav-list">
						<li class="nav-item"><a href="/executivePortal" class="nav-link">Home</a></li>
						<li class="nav-item"><a href="/executiveProperty" class="nav-link">Property</a></li>
						<li class="nav-item active">
							<div class="dropdown">
								...
								<div class="dropdown-content">
									<a href="/showExecutiveProfile">My Profile Details</a> 
									<a href="/show/getCustomerDetails">Customer Details</a> 
								</div>
							</div>
						</li>
	...
	<div class="row">
		...
		<h3 class="message">${message}</h3>
			<div class="card">
				...
				<div class="card-body">
					<form action="/executive/getExecutiveDetails" class="form">
						<div class="form-group">
							<label for="">Executive Id</label> <input type="number"
								name="execid" class="form-control rounded-0" pattern ="^. [0-9,.]*$" title="Executive Id should contain only numbers"  required>
						</div>
