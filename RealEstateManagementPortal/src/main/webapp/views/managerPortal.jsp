...
<body>
			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav-list">
						<li class="nav-item active"><a href="/managerPortal" class="nav-link">Home</a></li>
						<li class="nav-item"><a href="/managerProperty" class="nav-link">Property</a></li>
							...
							<div class="dropdown">
								...
								<div class="dropdown-content">
									<a href="/manager/createProperty">Create Property</a> <a href="/manager/createExecutive">Create
										Executive</a> <a href="/manager/showCustomerDetails">Get Customer Details</a>
										<a href="/manager/assignExecutive">Assign Executive to Customer</a>
								</div>
							</div>
						</li>
	...
	<div class="main-container">
		...
		<a href="/managerProperty"><button type="submit" class="btn">Get
