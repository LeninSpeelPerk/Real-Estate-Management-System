			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav-list">
						...
						<li class="nav-item active"><a href="/executiveProperty"
						...
						<li class="nav-item">
							<div class="dropdown">
								...
								<div class="dropdown-content">
									<a href="/showExecutiveProfile">My Profile</a>
		...
		<div class="col-left">
			...
			<div class="col2">
				<div class="card">
					...
					<div class="form-group">
						<form action="/executive/getAllProperties">
			...
			<div class="col3">
				<div class="card">
					...
					<div class="card-body">
						<form action="/executive/getAllPropertiesByType/{propertyType}" class="form">
							<div class="form-group">
			...
			<div class="col4">
				<div class="card">
					...
					<div class="card-body">
						<form action="/executive/getAllPropertiesByLocality/{locality}" class="form">
							<div class="form-group">
