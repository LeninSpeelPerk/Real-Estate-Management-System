			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav-list">
						<li class="nav-item"><a href="/customerPortal" class="nav-link">Home</a></li>
						<li class="nav-item"><a href="/customerProperty" class="nav-link">Property</a></li>
						<li class="nav-item active">
							<div class="dropdown">
								...
								<div class="dropdown-content">
									<a href="/addCustomerDetails">Add Details</a> <a href="/addRequirements">Add
										Requirement</a> <a href="/myRequirements">My Requirements</a>
								</div>
							</div>
						</li>
	...
	<div class="row">
		<div class="col1">
			<div class="card">
				...
				<div class="card-body">
					<form action="/customer/getCustomerDetails" class="form">
						<div class="form-group hidden">
							<label for="">customer Id</label> <input type="number"
								name="custid" value="${custId}" class="form-control rounded-0"
								pattern ="^. [0-9,.]*$" title="Customer Id should contain only numbers" required>
						</div>
		...
		<div class="col2">
			<div class="card">
				...
				<ul class="list-group list-group-flush">
					...
					<li class="list-group-item"><b>Requirements: </b></li>
				</ul>
				<table border="1">
					<tr>
						<th>Id</th>
