...
<body>
			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav-list">
						<li class="nav-item active"><a href="/customerPortal" class="nav-link">Home</a></li>
							...
							<div class="dropdown">
								...
								<div class="dropdown-content">
									<a href="/addCustomerDetails">Add Details</a> <a
										href="/addRequirements">Add Requirements</a> <a href="/myRequirements">My
										Requirements</a>
								</div>
							</div>
						</li>
	...
	<div class="main-container">
		...
		<a href="/customerProperty"><button type="submit" class="btn">Get
