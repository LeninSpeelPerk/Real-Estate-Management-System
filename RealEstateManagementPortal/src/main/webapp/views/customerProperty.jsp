			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav-list">
						...
						<li class="nav-item active"><a href="/customerProperty"
						...
						<li class="nav-item">
							<div class="dropdown">
								...
								<div class="dropdown-content">
									<a href="/addCustomerDetails">Add Details</a> <a
										href="/addRequirements">Add Requirements</a> <a
										href="/myRequirements">My Requirements</a>
								</div>
							</div>
						</li>
		...
		<div class="col-left">
			...
			<div class="col3">
				<div class="card">
					...
					<div class="card-body">
						<form action="/customer/getAllPropertiesByType/{propertyType}" class="form">
							<div class="form-group">
			...
			<div class="col4">
				<div class="card">
					...
					<div class="card-body">
						<form action="/customer/getAllPropertiesByLocality/{locality}" class="form">
							<div class="form-group">
