							...
							<div class="dropdown">
								...
								<div class="dropdown-content">
									<a href="/addCustomerDetails">Add Details</a> <a
										href="/addRequirements">Add Requirement</a> <a
	...
	<div class="row">
		<div class="col">
			...
			<div class="card rounded-0">
				...
				<div class="card-body">
					<form action="/customer/assignRequirements" class="form">
						<div class="form-group hidden">
							<label for="">Customer Id</label> <input type="number"
								name="customerId" value="${custId}" class="form-control hidden"
								pattern="^. [0-9,.]*$"
								title="Customer Id should contain only numbers" required>
						</div>
						...
						<div class="form-group">
							<label for="">Requirement Id</label> <input type="number"
								...
								pattern="^. [0-9,.]*$"
								title="Requirement Id should contain only numbers" required>
						</div>
